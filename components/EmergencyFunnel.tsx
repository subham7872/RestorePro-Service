...
interface EmergencyFunnelProps {
  onClose: () => void;
}

const EmergencyFunnel: React.FC<EmergencyFunnelProps> = ({ onClose }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white w-full max-w-xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
        <div className="bg-red-600 p-6 text-white flex justify-between items-center">
          <div>
            <h3 className="text-xl font-bold uppercase tracking-tight">Emergency Response Unit</h3>
        ...
        <div className="p-8">
          {step === 1 && (
            <div className="space-y-6">
              <h4 className="text-2xl font-extrabold text-slate-900">What is the emergency?</h4>
          ...
          {step === 2 && (
            <div className="space-y-6">
              <h4 className="text-2xl font-extrabold text-slate-900">Location & Details</h4>
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Service ZIP Code</label>
                <input 
                  type="text" 
                  value={zip}
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-2">Quick Description (Optional)</label>
                <textarea 
                  value={details}
              ...
              <button 
                ...
                className="w-full bg-red-600 text-white p-4 rounded-xl font-bold text-lg hover:bg-red-700 transition-all disabled:opacity-50 flex items-center justify-center"
              >
                {isGenerating ? (
          ...
          {step === 3 && (
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl">
                <h5 className="text-blue-800 font-bold mb-2 flex items-center">
              ...
              <h4 className="text-2xl font-extrabold text-slate-900">Who should we call?</h4>
              ...
              <button 
                type="submit"
                className="w-full bg-red-600 text-white p-5 rounded-xl font-bold text-xl hover:bg-red-700 transition-all shadow-xl shadow-red-600/20 active:scale-95"
              >
                DISPATCH TEAM NOW
              </button>
          ...
          {step === 4 && (
            <div className="text-center py-12 space-y-6">
              ...
              <h4 className="text-3xl font-extrabold text-slate-900">Team Dispatched!</h4>
              <p className="text-slate-600 max-w-sm mx-auto">
                A project manager has been assigned to your case and will call you within <span className="text-red-600 font-bold">5 minutes</span>.
              </p>
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 text-left">
                <p className="text-xs text-slate-500 font-bold uppercase mb-2">Assigned Tech</p>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-slate-200 rounded-full overflow-hidden">
                    <img src="https://picsum.photos/seed/tech/100" alt="Tech" />
                  </div>
                  <div>
                    <p className="font-bold text-slate-900">Marcus R.</p>
