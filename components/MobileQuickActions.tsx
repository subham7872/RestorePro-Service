...
const MobileQuickActions: React.FC<MobileQuickActionsProps> = ({ onEmergencyClick }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-slate-200 md:hidden flex h-16 shadow-[0_-4px_10px_rgba(0,0,0,0.1)]">
      ...
      >
        ...
        <span className="text-[10px] font-extrabold uppercase tracking-tight">Call Dispatch</span>
      </a>
      ...
      >
        ...
        <span className="text-[10px] font-extrabold uppercase tracking-tight">Emergency Help</span>
      </button>
      ...
      >
        ...
        <span className="text-[10px] font-extrabold uppercase tracking-tight">Location</span>
      </a>
    </div>
  );
};
