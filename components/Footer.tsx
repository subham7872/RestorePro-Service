    ...
    <footer className="bg-slate-900 border-t border-slate-800 pt-16 pb-24 md:pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Serving the community with integrity and speed for over 25 years. We are your local partners in disaster recovery.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3 text-slate-400 text-sm">
                ...
                <span>123 Restoration Way,<br />Disaster City, US 90210</span>
              </div>
              <div className="flex items-center space-x-3 text-slate-400 text-sm">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="text-white font-bold">1-800-RESTORE</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 text-center text-slate-500 text-xs">
          <p>© {new Date().getFullYear()} RestorePro Services. All Rights Reserved. Licensed & Insured #123456789.</p>
        </div>
      </div>
    </footer>
  );
