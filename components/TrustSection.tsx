      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center opacity-70 grayscale hover:grayscale-0 transition-all">
          <div className="flex flex-col items-center">
             <div className="bg-white p-3 rounded-full shadow-sm mb-2 border border-slate-200">
               <span className="text-2xl font-bold text-slate-900 italic">IICRC</span>
             </div>
             <span className="text-[10px] font-bold text-slate-500 uppercase">Certified Firm</span>
          </div>
          <div className="flex flex-col items-center">
             <div className="bg-white p-3 rounded-full shadow-sm mb-2 border border-slate-200">
               <span className="text-2xl font-bold text-slate-900">EPA</span>
             </div>
             <span className="text-[10px] font-bold text-slate-500 uppercase">Lead-Safe Firm</span>
          </div>
          <div className="flex flex-col items-center">
             <div className="bg-white p-3 rounded-full shadow-sm mb-2 border border-slate-200">
               <span className="text-2xl font-bold text-slate-900">BBB</span>
             </div>
             <span className="text-[10px] font-bold text-slate-500 uppercase">A+ Accredited</span>
          </div>
          <div className="flex flex-col items-center">
             <div className="bg-white p-3 rounded-full shadow-sm mb-2 border border-slate-200">
               <span className="text-2xl font-bold text-slate-900">RIA</span>
             </div>
             <span className="text-[10px] font-bold text-slate-500 uppercase">Member Since '02</span>
          </div>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="flex space-x-4">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-lg mb-1">Fast Response Time</h4>
          ...
          <div className="flex space-x-4">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-lg mb-1">Insurance Direct Billing</h4>
          ...
          <div className="flex space-x-4">
            ...
            <div>
              <h4 className="font-bold text-slate-900 text-lg mb-1">Modern Equipment</h4>
